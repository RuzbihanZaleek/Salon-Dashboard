...
export default function Reservations() {
    ...
    const columns = [
        ...
        { field: "date", headerName: "DATE", type: "date", flex: 1, editable: true },
        // {
        //     field: "time", headerName: "TIME", valueFormatter: ({ value }) => valueFormatter.format("DD/MM/YYYY hh:mm A"), flex: 1, editable: true
        // },
        { field: "time", headerName: "TIME", type: 'dateTime', format: 'hh:mm A', flex: 1, editable: true },
        { field: "status", headerName: "STATUS", type: 'singleSelect', valueOptions: ['Not Completed', 'Inprogress', 'Completed'], flex: 1, editable: true },
        {
            field: 'actions',
            type: 'actions',
            headerName: 'ACTIONS',
